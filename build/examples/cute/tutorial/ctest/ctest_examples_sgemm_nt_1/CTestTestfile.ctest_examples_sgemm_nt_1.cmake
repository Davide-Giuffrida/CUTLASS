...
#?   message(STATUS "Skipping tests for $<TARGET_FILE:sgemm_nt_1> as $ENV{CUTLASS_TEST_SET} is not in the set of ${TEST_SETS_SUPPORTED}.")
#?   return()
#? endif()

set(TEST_EXE_PATH $<TARGET_FILE:sgemm_nt_1>)
...
if (CUTLASS_USE_EXTENDED_ADD_TEST_FORMAT)
  ...
  add_test(NAME ctest_examples_sgemm_nt_1 COMMAND ${_CUTLASS_TEST_EXECUTION_ENVIRONMENT} "${TEST_EXE_PATH}" )
else()
  add_test(ctest_examples_sgemm_nt_1 ${_CUTLASS_TEST_EXECUTION_ENVIRONMENT} "${TEST_EXE_PATH}" )
endif()

if (TEST_EXE_WORKING_DIRECTORY)
  set_tests_properties(ctest_examples_sgemm_nt_1 PROPERTIES WORKING_DIRECTORY "${TEST_EXE_WORKING_DIRECTORY}")
endif()
